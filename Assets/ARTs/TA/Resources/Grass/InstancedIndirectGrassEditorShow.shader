Shader "Custom/SingleGrassEditorShow"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        HLSLINCLUDE
            ...
            CBUFFER_START(UnityPerMaterial)
                ...
                StructuredBuffer<float> _AllGrassHeightBuffer;
                StructuredBuffer<float> _AllGrassWidthBuffer;
            CBUFFER_END
            ...
            float3 GetPositionWS(float3 posWS, Attributes input, uint instanceID : SV_InstanceID)
            {
                float3 perGrassPivotPosWS = posWS;
                //Random Size
                ...
                float3 positionWS = TransformObjectToWorld(positionOS); //positionOS + perGrassPivotPosWS
        ...
        Pass
        {
            ...
            Varyings vert(Attributes input, uint instanceID : SV_InstanceID)
            {
                ...
                positionWS = GetPositionWS(positionWS, input, instanceID);
