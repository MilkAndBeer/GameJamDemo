...
AmbientOcclusionFactor CreateAmbientOcclusionFactor(InputData inputData, customData customData)
{
    return CreateAmbientOcclusionFactor(inputData.normalizedScreenSpaceUV, customData.occlusion);
}
