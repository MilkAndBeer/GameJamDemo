Shader "Custom/Lit"
{
    Properties
    {
        ...
        [Toggle(_RANDOM)] _RandomColor("Enable Random Color", Float) = 0.0
        ...
        [Toggle(_ISLIGHT)] _IsLight("It is a light", Float) = 0
        ...
        [Toggle(_SUBSURFACE)] _SubsrufaceOn ("Enable Subsurface", Float) = 0
        _SubsurfaceColor ("Subsurface Color", Color) = (1, 1, 1, 1)
        _SubsurfaceIntensity ("Subsurface Intensity", Range(0, 1)) = 0
        _SubsurfaceFalloff ("Subsurface Falloff", Range(0, 10)) = 0.5
...
//        _BendNoise ("Bend Noise", Range(0, 50)) = 20
        ...
        [Toggle(_SNOW_OFF)] _SnowOff("Snow Off", Float) = 1
